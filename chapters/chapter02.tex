...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/slam-01.png}
    \caption{示例图片标题}
    \label{fig:example}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/slam-01.png}
    \bicaption{图片标题示例}{Figure title example}
    \label{fig:example}
\end{figure}
...
\begin{table}[htbp]
    \centering
    \bicaption{示例三线表}{three line table example}
    \label{tab:example}
    \begin{tabular}{lccc}
        \toprule
        名称 & 参数1 & 参数2 & 参数3 \\
